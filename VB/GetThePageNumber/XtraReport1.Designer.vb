...
Namespace GetThePageNumber
	Partial Public Class XtraReport1
		...
		Private Sub InitializeComponent()
			...
			Me.ReportPrintOptions.DetailCountOnEmptyDataSource = 200
...
'			Me.xrLabel1.PrintOnPage += New DevExpress.XtraReports.UI.PrintOnPageEventHandler(Me.xrLabel1_PrintOnPage);
			' 
			' XtraReport1
			' 
